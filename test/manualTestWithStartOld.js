...
setTimeout(function () {
    sender.sendTextMessage(1228718113827026, "echo startMessageData");
    consumer.consumePostback(startMessageData)
}, 1500);
setTimeout(function () {
    sender.sendTextMessage(1228718113827026, "echo isbnMessageData");
    consumer.consumeMessage(isbnMessageData)
}, 2000);

setTimeout(function () {
    sender.sendTextMessage(1228718113827026, "echo pageMessageData");
    consumer.consumeMessage(pageMessageData)
}, 2500);
setTimeout(function () {
    sender.sendTextMessage(1228718113827026, "echo exMessageData");
    consumer.consumeMessage(exMessageData)
}, 3000);
setTimeout(function () {
    sender.sendTextMessage(1228718113827026, "echo imageMessageData");
